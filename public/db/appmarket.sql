...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-07-2016 a las 22:46:31
...
ALTER TABLE `producto_venta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_producto_venta_products1_idx` (`products_id`);
...
--
ALTER TABLE `producto_venta`
  ADD CONSTRAINT `fk_producto_venta_products1` FOREIGN KEY (`products_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
